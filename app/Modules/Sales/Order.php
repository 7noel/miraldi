...
class Order extends Model implements Auditable
{
	...
	{
		return $this->hasOne('App\Modules\Sales\Order');
	}
	...
	{
		return $this->belongsTo('App\Modules\HumanResources\Employee', 'seller_id');
	}
