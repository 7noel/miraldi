...
class Company extends Model implements Auditable {
	...
	protected $fillable = ['company_name', 'brand_name', 'name', 'paternal_surname', 'maternal_surname', 'id_type_id', 'doc', 'address', 'ubigeo_id', 'phone', 'mobile', 'email', 'contact', 'comment', 'birth', 'is_client', 'is_provider','is_my_company', 'is_shipper', 'country_id'];
