					...
					<div class="form-group form-group-sm">
						{!! Form::label('issued_at','Fecha', ['class'=>'col-sm-2 control-label']) !!}
						<div class="col-sm-2">
							{!! Form::date('issued_at', null, ['class'=>'form-control col-sm-2', 'required']) !!}
						</div>
						{!! Form::label('document_type_id','Documento', ['class'=>'col-sm-2 control-label']) !!}
						<div class="col-sm-2">
							{!! Form::select('document_type_id',$document_types , null, ['class'=>'form-control col-sm-1', 'required']) !!}
						</div>
						{!! Form::label('sn','Numero', ['class'=>'col-sm-2 control-label']) !!}
						<div class="col-sm-2">
							{!! Form::text('sn', null, ['class'=>'form-control uppercase', 'required', 'placeholder'=>'Número']) !!}
						</div>
					</div>
					<div class="form-group form-group-sm">
